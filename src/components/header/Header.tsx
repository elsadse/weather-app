...
export function Header() {
    ...
    return (
        <div className="flex flex-row justify-between items-center h-[33px] md:h-11">
    ...
    return (
        <div className="relative">
            <div onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                className="flex flex-row gap-x-1.5 md:gap-2.5 lg:gap-3 px-2.5 md:px-4 py-2 md:py-3 justify-between items-center bg-neutral-800 rounded-6"
            >
