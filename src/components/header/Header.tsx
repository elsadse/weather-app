...
export function Header() {
    ...
    return (
        <div className="flex flex-row justify-between items-center h-[33px] md:h-[43px] lg:w-[1216px]">
    ...
    return (
        <div className="relative">
            <div onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                className="flex flex-row gap-x-1.5 md:gap-2.5 lg:gap-3 px-2.5 md:px-4 py-2 md:py-3 justify-between items-center bg-neutral-800 rounded-6 cursor-pointer"
            >
...
function UnitDropdown() {
    ...
    return (
        <div
            className="w-55 h-auto flex flex-col gap-y-1 px-2 py-1.5 rounded-12 bg-neutral-800 absolute right-0 top-10 md:top-13"
        >
            ...
            <div className="h-px bg-neutral-600" />
            <UnitDropdownOption unitSystem={unitSystem} label="Precipitation" metric="mm"
                imperial="Inches (in)" />
        </div>
    )
}
